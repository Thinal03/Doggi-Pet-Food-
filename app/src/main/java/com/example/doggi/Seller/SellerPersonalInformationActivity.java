...
public class SellerPersonalInformationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seller_personalinformation); // Change to the appropriate layout for an activity
